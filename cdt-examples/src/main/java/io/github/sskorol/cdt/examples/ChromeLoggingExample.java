...
import io.github.sskorol.cdt.launch.ChromeArguments;
...
/**
 * By setting logger `io.github.sskorol.cdt.launch.chrome.output` to DEBUG level, either
 ...
 *
 * <p>Logger `io.github.sskorol.cdt.launch.chrome.output` can be set to DEBUG level programmatically
 * as in an example below (enableDebugChromeOutput method) or by introducing
 *
 * <pre>
 *   <logger name="io.github.sskorol.cdt.launch.chrome.output" level="DEBUG" />
 * </pre>
 *
...
public class ChromeLoggingExample {
  ...
  /**
   * Programmatically set `io.github.sskorol.cdt.launch.chrome.output` to DEBUG level so chrome
   * output can be observed.
   */
  private static void enableDebugChromeOutput() {
    LoggerContext loggerContext = (LoggerContext) LoggerFactory.getILoggerFactory();
    loggerContext.getLogger("io.github.sskorol.cdt.launch.chrome.output").setLevel(Level.DEBUG);
  }

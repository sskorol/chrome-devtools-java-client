...
import static io.github.sskorol.cdt.definition.builder.support.utils.StringUtils.*;

import io.github.sskorol.cdt.definition.builder.support.java.builder.*;
...
import io.github.sskorol.cdt.definition.builder.support.protocol.builder.support.PropertyHandlerResult;
import io.github.sskorol.cdt.definition.builder.support.protocol.builder.support.TypeBuildRequest;
...
import io.github.sskorol.cdt.protocol.definition.types.type.object.properties.*;
import io.github.sskorol.cdt.protocol.definition.types.type.object.properties.array.ArrayItem;
import io.github.sskorol.cdt.protocol.definition.types.type.object.properties.array.items.*;
import java.util.*;
...
public class TypesBuilder {
  ...
  static {
    registerTypeArrayItem(
        io.github.sskorol.cdt.protocol.definition.types.type.array.items.StringArrayItem.class,
        "String");
    registerTypeArrayItem(
        io.github.sskorol.cdt.protocol.definition.types.type.array.items.NumberArrayItem.class,
        "Double");
    registerTypeArrayItem(
        io.github.sskorol.cdt.protocol.definition.types.type.array.items.IntegerArrayItem.class,
        "Integer");
  }
  ...
  protected String addRefImportStatement(
    ...
    if (isArrayType(type)) {
      ...
      if (isRefArrayItemType(arrayType.getItems())) {
        io.github.sskorol.cdt.protocol.definition.types.type.array.items.RefArrayItem refArrayItem =
            (io.github.sskorol.cdt.protocol.definition.types.type.array.items.RefArrayItem)
                arrayType.getItems();
  ...
  protected static boolean isRefArrayItemType(
      io.github.sskorol.cdt.protocol.definition.types.type.array.ArrayItem arrayItem) {
    return arrayItem
        instanceof io.github.sskorol.cdt.protocol.definition.types.type.array.items.RefArrayItem;
  }
   ...
   * @param <T> Array item class type.
   */
  private static <T extends io.github.sskorol.cdt.protocol.definition.types.type.array.ArrayItem>

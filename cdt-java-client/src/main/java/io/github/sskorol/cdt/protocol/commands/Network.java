...
import io.github.sskorol.cdt.protocol.events.network.DataReceived;
import io.github.sskorol.cdt.protocol.events.network.EventSourceMessageReceived;
import io.github.sskorol.cdt.protocol.events.network.LoadingFailed;
import io.github.sskorol.cdt.protocol.events.network.LoadingFinished;
import io.github.sskorol.cdt.protocol.events.network.ReportingApiEndpointsChangedForOrigin;
import io.github.sskorol.cdt.protocol.events.network.ReportingApiReportAdded;
import io.github.sskorol.cdt.protocol.events.network.ReportingApiReportUpdated;
import io.github.sskorol.cdt.protocol.events.network.RequestIntercepted;
import io.github.sskorol.cdt.protocol.events.network.RequestServedFromCache;
import io.github.sskorol.cdt.protocol.events.network.RequestWillBeSent;
import io.github.sskorol.cdt.protocol.events.network.RequestWillBeSentExtraInfo;
import io.github.sskorol.cdt.protocol.events.network.ResourceChangedPriority;
import io.github.sskorol.cdt.protocol.events.network.ResponseReceived;
import io.github.sskorol.cdt.protocol.events.network.ResponseReceivedExtraInfo;
import io.github.sskorol.cdt.protocol.events.network.SignedExchangeReceived;
import io.github.sskorol.cdt.protocol.events.network.SubresourceWebBundleInnerResponseError;
import io.github.sskorol.cdt.protocol.events.network.SubresourceWebBundleInnerResponseParsed;
import io.github.sskorol.cdt.protocol.events.network.SubresourceWebBundleMetadataError;
import io.github.sskorol.cdt.protocol.events.network.SubresourceWebBundleMetadataReceived;
import io.github.sskorol.cdt.protocol.events.network.TrustTokenOperationDone;
import io.github.sskorol.cdt.protocol.events.network.WebSocketClosed;
import io.github.sskorol.cdt.protocol.events.network.WebSocketCreated;
import io.github.sskorol.cdt.protocol.events.network.WebSocketFrameError;
import io.github.sskorol.cdt.protocol.events.network.WebSocketFrameReceived;
import io.github.sskorol.cdt.protocol.events.network.WebSocketFrameSent;
import io.github.sskorol.cdt.protocol.events.network.WebSocketHandshakeResponseReceived;
import io.github.sskorol.cdt.protocol.events.network.WebSocketWillSendHandshakeRequest;
import io.github.sskorol.cdt.protocol.events.network.WebTransportClosed;
import io.github.sskorol.cdt.protocol.events.network.WebTransportConnectionEstablished;
import io.github.sskorol.cdt.protocol.events.network.WebTransportCreated;
...
import io.github.sskorol.cdt.protocol.types.network.AuthChallengeResponse;
import io.github.sskorol.cdt.protocol.types.network.ConnectionType;
import io.github.sskorol.cdt.protocol.types.network.ContentEncoding;
...
import io.github.sskorol.cdt.protocol.types.network.CookiePriority;
import io.github.sskorol.cdt.protocol.types.network.CookieSameSite;
import io.github.sskorol.cdt.protocol.types.network.CookieSourceScheme;
import io.github.sskorol.cdt.protocol.types.network.ErrorReason;
import io.github.sskorol.cdt.protocol.types.network.LoadNetworkResourceOptions;
import io.github.sskorol.cdt.protocol.types.network.LoadNetworkResourcePageResult;
import io.github.sskorol.cdt.protocol.types.network.RequestPattern;
import io.github.sskorol.cdt.protocol.types.network.ResponseBody;
import io.github.sskorol.cdt.protocol.types.network.ResponseBodyForInterception;
import io.github.sskorol.cdt.protocol.types.network.SecurityIsolationStatus;

...
public enum AttributionReportingIssueType {
  ...
  @JsonProperty("InvalidAttributionSourceExpiry")
  INVALID_ATTRIBUTION_SOURCE_EXPIRY,
  @JsonProperty("InvalidAttributionSourcePriority")
  INVALID_ATTRIBUTION_SOURCE_PRIORITY
}

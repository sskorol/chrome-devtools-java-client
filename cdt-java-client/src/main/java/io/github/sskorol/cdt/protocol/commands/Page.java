...
import io.github.sskorol.cdt.protocol.events.page.BackForwardCacheNotUsed;
import io.github.sskorol.cdt.protocol.events.page.CompilationCacheProduced;
import io.github.sskorol.cdt.protocol.events.page.DocumentOpened;
import io.github.sskorol.cdt.protocol.events.page.DomContentEventFired;
import io.github.sskorol.cdt.protocol.events.page.DownloadProgress;
import io.github.sskorol.cdt.protocol.events.page.DownloadWillBegin;
import io.github.sskorol.cdt.protocol.events.page.FileChooserOpened;
import io.github.sskorol.cdt.protocol.events.page.FrameAttached;
import io.github.sskorol.cdt.protocol.events.page.FrameClearedScheduledNavigation;
import io.github.sskorol.cdt.protocol.events.page.FrameDetached;
import io.github.sskorol.cdt.protocol.events.page.FrameNavigated;
import io.github.sskorol.cdt.protocol.events.page.FrameRequestedNavigation;
import io.github.sskorol.cdt.protocol.events.page.FrameResized;
import io.github.sskorol.cdt.protocol.events.page.FrameScheduledNavigation;
import io.github.sskorol.cdt.protocol.events.page.FrameStartedLoading;
import io.github.sskorol.cdt.protocol.events.page.FrameStoppedLoading;
import io.github.sskorol.cdt.protocol.events.page.InterstitialHidden;
import io.github.sskorol.cdt.protocol.events.page.InterstitialShown;
import io.github.sskorol.cdt.protocol.events.page.JavascriptDialogClosed;
import io.github.sskorol.cdt.protocol.events.page.JavascriptDialogOpening;
import io.github.sskorol.cdt.protocol.events.page.LifecycleEvent;
import io.github.sskorol.cdt.protocol.events.page.LoadEventFired;
import io.github.sskorol.cdt.protocol.events.page.NavigatedWithinDocument;
import io.github.sskorol.cdt.protocol.events.page.PrerenderAttemptCompleted;
import io.github.sskorol.cdt.protocol.events.page.ScreencastFrame;
import io.github.sskorol.cdt.protocol.events.page.ScreencastVisibilityChanged;
import io.github.sskorol.cdt.protocol.events.page.WindowOpen;
...
import io.github.sskorol.cdt.protocol.types.debugger.SearchMatch;
import io.github.sskorol.cdt.protocol.types.page.AppId;
import io.github.sskorol.cdt.protocol.types.page.AppManifest;
import io.github.sskorol.cdt.protocol.types.page.CaptureScreenshotFormat;
import io.github.sskorol.cdt.protocol.types.page.CaptureSnapshotFormat;
import io.github.sskorol.cdt.protocol.types.page.CompilationCacheParams;
import io.github.sskorol.cdt.protocol.types.page.FontFamilies;
import io.github.sskorol.cdt.protocol.types.page.FontSizes;
import io.github.sskorol.cdt.protocol.types.page.FrameResourceTree;
import io.github.sskorol.cdt.protocol.types.page.FrameTree;
import io.github.sskorol.cdt.protocol.types.page.InstallabilityError;
import io.github.sskorol.cdt.protocol.types.page.LayoutMetrics;
import io.github.sskorol.cdt.protocol.types.page.Navigate;
import io.github.sskorol.cdt.protocol.types.page.NavigationHistory;
import io.github.sskorol.cdt.protocol.types.page.OriginTrial;
import io.github.sskorol.cdt.protocol.types.page.PermissionsPolicyFeatureState;
import io.github.sskorol.cdt.protocol.types.page.PrintToPDF;
import io.github.sskorol.cdt.protocol.types.page.PrintToPDFTransferMode;
import io.github.sskorol.cdt.protocol.types.page.ReferrerPolicy;
import io.github.sskorol.cdt.protocol.types.page.ResourceContent;
import io.github.sskorol.cdt.protocol.types.page.ScriptFontFamilies;
import io.github.sskorol.cdt.protocol.types.page.SetDownloadBehaviorBehavior;
import io.github.sskorol.cdt.protocol.types.page.SetSPCTransactionModeMode;
import io.github.sskorol.cdt.protocol.types.page.SetWebLifecycleStateState;
import io.github.sskorol.cdt.protocol.types.page.StartScreencastFormat;
import io.github.sskorol.cdt.protocol.types.page.TransitionType;

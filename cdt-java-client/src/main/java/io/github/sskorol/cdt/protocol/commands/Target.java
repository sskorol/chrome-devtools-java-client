...
import io.github.sskorol.cdt.protocol.events.target.AttachedToTarget;
import io.github.sskorol.cdt.protocol.events.target.DetachedFromTarget;
import io.github.sskorol.cdt.protocol.events.target.ReceivedMessageFromTarget;
import io.github.sskorol.cdt.protocol.events.target.TargetCrashed;
import io.github.sskorol.cdt.protocol.events.target.TargetCreated;
import io.github.sskorol.cdt.protocol.events.target.TargetDestroyed;
import io.github.sskorol.cdt.protocol.events.target.TargetInfoChanged;
...
import io.github.sskorol.cdt.protocol.types.target.RemoteLocation;
import io.github.sskorol.cdt.protocol.types.target.TargetInfo;

package io.github.sskorol.cdt.services.config;
...
import io.github.sskorol.cdt.services.executors.DefaultEventExecutorService;
import io.github.sskorol.cdt.services.executors.EventExecutorService;
import io.github.sskorol.cdt.services.utils.ConfigurationUtils;
...
public class ChromeDevToolsServiceConfiguration {
  private static final String READ_TIMEOUT_PROPERTY =
      "io.github.sskorol.cdt.services.config.readTimeout";

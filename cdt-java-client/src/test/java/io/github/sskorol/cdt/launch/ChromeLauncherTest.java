...
import io.github.sskorol.cdt.launch.ChromeLauncher.Environment;
import io.github.sskorol.cdt.launch.ChromeLauncher.ShutdownHookRegistry;
...
public class ChromeLauncherTest extends EasyMockSupport {
  ...
  public void testLaunchWithDebugLogging()
    ...
    registerAppenderOnDebugLogger(
        "io.github.sskorol.cdt.launch.chrome.output", Level.DEBUG, loggingEvents);
  ...
  public void testLaunchWithErrorLoggingDoesNotLogAnything()
    ...
    List<String> loggingEvents = new ArrayList<>();
    registerAppenderOnDebugLogger(
        "io.github.sskorol.cdt.launch.chrome.output", Level.ERROR, loggingEvents);
